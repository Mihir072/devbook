...
import 'package:devbook/Web%20Development/Data/web_data.dart';
...
class WebAns extends StatefulWidget {
  const WebAns({super.key});

  @override
  State<WebAns> createState() => _WebAnsState();
}

class _WebAnsState extends State<WebAns> {
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                webUser[index].question, // HERE IS QUESTION
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  webUser[index].answer, //  HERE IS ASNWER
                                  style: const TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 17,
